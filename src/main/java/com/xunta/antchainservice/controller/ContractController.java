...
import com.xunta.antchainservice.bean.contract.ContractCallResponse;
...
public class ContractController {
    ...
    @GetMapping("/api/contract/get_batch_count")
    ...
    @GetMapping("/api/contract/get_token_mint_count")
    ...
    @GetMapping("/api/contract/get_token_remain_count")
    ...
    @GetMapping("/api/contract/get_token_uri")
    ...
    @GetMapping("/api/contract/get_token_creator")
    ...
    @GetMapping("/api/contract/get_sub_token_owner")
    ...
    @GetMapping("/api/contract/get_token_create_time")
    ...
    @GetMapping("/api/contract/get_sub_token_last_update_time")
    ...
    @GetMapping("/api/contract/transfer")
